<template>
  <div class="app-container">
    <el-row :gutter="20" style="display: flex;justify-content: center;">
      <el-col :xs="24" :sm="24" :md="8" :lg="8" :xl="5" style="margin-bottom: 10px">
        <el-card class="box-card">
          ...
          <div>
            ...
            <ul class="user-info">
              ...
              <li><svg-icon icon-class="user1" /> 姓 名 <div class="user-right">{{user.name}}</div></li>
              <li><svg-icon icon-class="phone" /> 手机号 <div class="user-right"> {{user.phone}}</div></li>
              <li><svg-icon icon-class="email" /> 工 号 <div class="user-right">{{user.code}}</div></li>
              <li>
                <svg-icon icon-class="anq" /> 密码
...
export default {
  ...
  created() {
    ...
    console.log(this.user,this.$store,"用户信息----------");
